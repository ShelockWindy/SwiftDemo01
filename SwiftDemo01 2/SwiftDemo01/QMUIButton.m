...
- (void)layoutSubviews {
    ...
    if (self.imagePosition == QMUIButtonImagePositionLeft) {
        ...
        self.imageView.frame = CGRectMake(self.imageView.frame.origin.x-_imageSpace/2, self.imageView.frame.origin.y, self.imageView.frame.size.width, self.imageView.frame.size.height);
        self.titleLabel.frame = CGRectMake(self.titleLabel.frame.origin.x+_imageSpace/2, self.titleLabel.frame.origin.y, self.titleLabel.frame.size.width, self.titleLabel.frame.size.height);
    ...
    if (self.imagePosition == QMUIButtonImagePositionTop || self.imagePosition == QMUIButtonImagePositionBottom) {
        ...
        if (_imagePosition==QMUIButtonImagePositionTop) {
            
            self.imageView.frame = CGRectMake(self.imageView.frame.origin.x, self.imageView.frame.origin.y-_imageSpace/2, self.imageView.frame.size.width, self.imageView.frame.size.height);
            self.titleLabel.frame = CGRectMake(self.titleLabel.frame.origin.x, self.titleLabel.frame.origin.y+_imageSpace/2, self.titleLabel.frame.size.width, self.titleLabel.frame.size.height);

            
        }else if (_imagePosition==QMUIButtonImagePositionBottom)
        {
            self.imageView.frame = CGRectMake(self.imageView.frame.origin.x, self.imageView.frame.origin.y+_imageSpace/2, self.imageView.frame.size.width, self.imageView.frame.size.height);
            self.titleLabel.frame = CGRectMake(self.titleLabel.frame.origin.x, self.titleLabel.frame.origin.y-_imageSpace/2, self.titleLabel.frame.size.width, self.titleLabel.frame.size.height);
