...
+ (instancetype)sharedSessionManager {
    ...
    static TJHTTPSessionManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[TJHTTPSessionManager alloc] initWithBaseURL:[NSURL URLWithString:kBASE_URL]];
...
{
    //先导入证书，找到证书的路径
    NSString *cerPath = [[NSBundle mainBundle] pathForResource:@"560" ofType:@"cer"];
